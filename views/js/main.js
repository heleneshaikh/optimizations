...
var selectRandomMeat = function () {
    return INGREDIENTS.meats[Math.floor((Math.random() * INGREDIENTS.meats.length))];
};

var selectRandomNonMeat = function () {
    return INGREDIENTS.nonMeats[Math.floor((Math.random() * INGREDIENTS.nonMeats.length))];
};

var selectRandomCheese = function () {
    return INGREDIENTS.cheeses[Math.floor((Math.random() * INGREDIENTS.cheeses.length))];
};

var selectRandomSauce = function () {
    return INGREDIENTS.sauces[Math.floor((Math.random() * INGREDIENTS.sauces.length))];
};

var selectRandomCrust = function () {
    return INGREDIENTS.crusts[Math.floor((Math.random() * INGREDIENTS.crusts.length))];
};
...
var pizzaElementGenerator = function () {
    ...
    for (var k = 0; k < 50; k++) {
        ...
        pizzaContainer.id = "pizza" + k;                // gives each pizza element a unique id
        pizzaImageContainer.style.width = "35%";

        pizzaImage.src = "images/pizzas.png";
...
document.addEventListener('DOMContentLoaded', function () {
    var cols = 6;
    var s = 256;
    for (var i = 0; i < window.screen.height; i++) {
